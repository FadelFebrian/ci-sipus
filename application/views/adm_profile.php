    ...
    <section>
      <div class="row">
        ...
        <div style="text-align: justify" class="span8">
          <form action="<?php echo site_url(); ?>/AdmDashboard/profile" method="post">
            <textarea class="input-xxlarge" name="base_content" rows="5"><?php echo $base->base_content;?></textarea>
